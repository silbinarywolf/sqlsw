...
// todo(jae): 2022-10-30
// Add tests for named parameters in sqlparser, cover these cases
// also add backwards compat support for escaped : character
...
// todo(jae): 2022-10-30
// Make this test pass in sqlparser tests
